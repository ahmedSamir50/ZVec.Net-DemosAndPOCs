...
| **Vector DB** | ZVec.NET (NuGet) | 1.0.0-beta.3.1 | HNSW vector storage, similarity search, metadata filtering |
...
| ZVec.NET is beta (1.0.0-beta.3.1) | API may change | Pin version; test thoroughly |
