...
Proof in this repo: [Advanced/](Advanced/) (Jira RAG) and [examples/01-clip-onnx](examples/01-clip-onnx/) (CLIP gallery). Talk track: [ZVec.NET_Team_Session.html](ZVec.NET_Team_Session.html).
...
Session deck: [ZVec.NET_Team_Session.html](ZVec.NET_Team_Session.html)
